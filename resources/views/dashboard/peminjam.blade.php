                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="assets/media/svg/illustrations/easy/2.svg" class="theme-light-show h-125px"
                                        alt="" />
                            ...
                            <div class="text-center mb-1">
                                ...
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="index93d4.html?page=account/billing">
                                    Learn More </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="index28ff.html?page=account/statements" class="btn btn-sm btn-light">History</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
