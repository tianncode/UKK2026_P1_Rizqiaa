                ...
                <div class="app-container  container-fluid d-flex align-items-stretch flex-stack mt-7 "
                    ...
                    <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
                        <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                            ...
                            {{-- VIOLATION WARNING --}}
                            @php
                                $headerViolations = \App\Models\Violations::where('user_id', auth()->id())
                                    ->where('status', 'pending')
                                    ->get();
                                $headerViolationPoints = $headerViolations->sum('points');
                            @endphp

                            @if ($headerViolationPoints > 0)
                                <div class="app-navbar-item d-flex align-items-center ms-3">
                                    <div class="d-flex align-items-center gap-2 bg-light-danger rounded px-3 py-2 cursor-pointer"
                                        data-bs-toggle="popover" data-bs-trigger="hover focus"
                                        data-bs-placement="bottom" data-bs-html="true"
                                        data-bs-content="
                        <div style='min-width:220px'>
                            <div class='fw-bold text-danger fs-7 mb-3'>Pelanggaran Aktif</div>
                            <div class='d-flex flex-column gap-2'>
                                @foreach ($headerViolations as $v)
<div class='d-flex justify-content-between align-items-center'>
                                        <span class='text-gray-700 fs-7'>
                                            @if ($v->type === 'late_return')
<i class=\'ki-duotone ki-time fs-6 text-warning me-1\'><span class=\'path1\'></span><span class=\'path2\'></span></i> Keterlambatan
@elseif ($v->type === 'damage')
<i class=\'ki-duotone ki-wrench fs-6 text-danger me-1\'><span class=\'path1\'></span><span class=\'path2\'></span></i> Kerusakan
@elseif ($v->type === 'loss')
<i class=\'ki-duotone ki-cross-circle fs-6 text-danger me-1\'><span class=\'path1\'></span><span class=\'path2\'></span></i> Kehilangan
@endif
                                        </span>
                                        <span class='badge badge-light-danger ms-3'>{{ $v->points }} poin</span>
                                    </div>
@endforeach
                            </div>
                            <div class='separator my-2'></div>
                            <div class='d-flex justify-content-between align-items-center'>
                                <span class='fw-bold fs-7 text-gray-800'>Total</span>
                                <span class='badge badge-danger'>{{ $headerViolationPoints }} poin</span>
                            </div>
                        </div>
                    ">
                                        <i class="ki-duotone ki-warning-2 fs-4 text-danger">
                                            <span class="path1"></span><span class="path2"></span>
                                        </i>
                                        <span class="text-danger fw-bold fs-7 d-none d-md-inline">
                                            {{ $headerViolationPoints }} Poin Pelanggaran
                                        </span>
                                    </div>
                                </div>
                            @endif
                            {{-- END VIOLATION WARNING --}}
                            ...
                            <div id="kt_app_sidebar_navs_scroll" class="hover-scroll-y mx-2 my-2"
                                ...
                                <div id="kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    @if (Auth::user()->role == 'employee')
                                        {{-- Dashboard --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('dashboard.petugas') }}">
                                    ...
                                    @if (Auth::user()->role == 'user')
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('loans.show') }}">
                                                <span class="menu-icon">
                                                    <i class="ki-duotone ki-arrow-circle-left fs-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                        ...
                                        {{-- Pengembalian --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('return.show') }}">
                                                <span class="menu-icon">
                                                    <i class="ki-duotone ki-arrow-circle-left fs-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                        ...
                                        {{-- Riwayat Peminjaman --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('loans.history') }}">
                                                <span class="menu-icon">
